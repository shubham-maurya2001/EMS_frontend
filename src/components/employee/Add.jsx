...
const Add = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://ems-server-drab.vercel.app/api/employee/add', formDataObj, {
        headers: {
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          <div>
            ...
            <input type="text" name='designation' onChange={handleChange} placeholder='Designation' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required autoComplete='username' />
          </div>
          {/* Department */}
          <div>
          ...
          <div>
            ...
            <input type="password" name='password' onChange={handleChange} placeholder='******' className='mt-1 p-2 block w-full border border-gray-300 rounded-md' required autoComplete='current-password' />
          </div>
          {/* Role */}
          <div>
